...
## Отключение Ren'Py Sync (синхронизация сохранений через интернет).
## Чтобы вернуть функцию — удалите строку ниже или замените на True.
...
define config.save_directory = "Khar-1749079055"
