...
translate chinese strings:
    ...
    new "基于 {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only] 引擎制作。\n\n[renpy.license!t]"
    ...
    new "启用支持的{a=https://www.renpy.org/l/voicing}语音合成器{/a}。"
