...
translate chinese strings:
    ...
    new "无障碍功能菜单。使用上下箭头导航，按 Enter 键激活按钮和调节条。"
    ...
    new "此菜单中的选项旨在提高无障碍性。它们可能不适用于所有游戏，某些选项组合可能导致游戏无法正常运行。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与原始大小一致。"
    ...
    new "此存档创建于其他设备。恶意构建的存档文件可能损害你的计算机。你是否信任此存档的创建者以及所有可能修改过此文件的人？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你是否信任创建此存档的设备？仅当你是该设备的唯一用户时，才应选择“是”。"
    ...
    new "本程序包含遵循多种许可证（包括 MIT 许可证和 GNU 宽松通用公共许可证）的自由软件。完整的软件列表及源代码链接可在此处找到：{a=https://www.renpy.org/l/license}这里{/a}。"
    ...
    new "剪贴板语音朗读已启用。按 'shift+C' 键禁用。"

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自动语音朗读将读出：\"[renpy.display.tts.last]\"。按 'alt+shift+V' 键禁用。"

    # renpy/common/00preferences.rpy:727
    old "Self-voicing enabled. Press 'v' to disable."
    new "自动语音朗读已启用。按 'v' 键禁用。"
    ...
    new "连接至 Ren'Py 同步服务器时发生未知错误。"

    # renpy/common/00sync.rpy:204
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "Ren'Py 同步服务器没有此同步数据的副本。同步 ID 可能无效，或已超时。"
    ...
    new "这将把你的存档上传至 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。\n是否继续？"
    ...
    new "你可以使用此 ID 在其他设备上下载你的存档。\n此同步数据将在一小时后过期。\nRen'Py 同步功能由 {a=https://www.renpy.org/sponsors.html}Ren'Py 赞助者{/a} 支持。"
    ...
    new "其图形驱动程序可能已过时或运行不正确。这可能导致图形显示缓慢或错误。"

    # renpy/common/00gltest.rpy:224
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a} 文件可能包含有助于你确定计算机问题所在的信息。"

    # renpy/common/00gltest.rpy:229
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "更多关于如何解决此问题的详细信息，请参阅 {a=[url]}文档{/a}。"
    ...
    new "将 traceback.txt 文件作为 BBcode 复制到剪贴板，适用于 https://lemmasoft.renai.us/ 等论坛。"
    ...
    new "将 traceback.txt 文件作为 Markdown 复制到剪贴板，适用于 Discord。"
